...
This is an experimental implementation of the AppImage command line tool, `appimagetool`, in Go, mainly to see what is possible. It can also do what [linuxdeployqt](https://github.com/linuxdeploy/linuxdeploy) does using the `deploy` verb.
